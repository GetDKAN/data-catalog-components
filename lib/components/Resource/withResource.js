      ...
      (0, _createClass2["default"])(_class, [{
        ...
        value: function () {
          ...
          _regenerator["default"].mark(function _callee() {
            ...
            var _this$props, data, rootUrl;

            return _regenerator["default"].wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _this$props = this.props, data = _this$props.data, rootUrl = _this$props.rootUrl;
        ...
        value: function () {
          ...
          _regenerator["default"].mark(function _callee3() {
            ...
            var dataPreview, _this$props2, data, rootUrl, columns, store;
            ...
            return _regenerator["default"].wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    dataPreview = this.state.dataPreview;
                    _this$props2 = this.props, data = _this$props2.data, rootUrl = _this$props2.rootUrl;
                    columns = null;
