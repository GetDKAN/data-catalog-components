...
var Search = function Search(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    searchState.pageSize = parsedQuery.pageSize ? parsedQuery.pageSize : _search_defaults.defaultSearchState.pageSize;
  }, [location]);
  (0, _react.useEffect)(function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                urlOptions = ['fulltext', 'sort', 'sort_order', 'pageSize', 'page'].concat((0, _toConsumableArray2["default"])(facetKeys)); // Get data
    ...
    getSearchData();
  }, [sortOptions, defaultFacets, path, setSearchUrl, searchEndpoint, searchState.sort, searchState.fulltext, searchState.pageSize, searchState.page, searchState.selectedFacets, normalize, location]);
