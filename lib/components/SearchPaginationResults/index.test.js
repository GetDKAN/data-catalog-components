...
describe('<SearchPaginationResults />', function () {
  test('renders with default class and correct message', function () {
    ...
    expect(_react2.screen.getByText(/datasets/).closest('div')).toHaveTextContent('1-20 out of 100 datasets');
  });
  test('renders with custom class and correct message', function () {
    ...
    expect(_react2.screen.getByText(/datasets/).closest('div')).toHaveTextContent('11-20 out of 500 datasets');
  });
});