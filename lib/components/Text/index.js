  ...
  var TextWrapper = function TextWrapper() {
    if (tag) {
      ...
      return _react["default"].createElement(TagElement, {
        className: classes
      }, label && _react["default"].createElement("strong", null, "".concat(label, ": ")), value ? parser.parse(value) : children);
    }

    return _react["default"].createElement(_react["default"].Fragment, null, label && _react["default"].createElement("strong", null, "".concat(label, ": ")), value ? parser.parse(value) : children);
  };

  return _react["default"].createElement(TextWrapper, null);
};
