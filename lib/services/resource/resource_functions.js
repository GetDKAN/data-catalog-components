    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            store = _context.sent;
            _store$getDatastoreIn = store.getDatastoreInfo().columns, sqlColumns = _store$getDatastoreIn.sqlColumns, numOfRows = _store$getDatastoreIn.count;
