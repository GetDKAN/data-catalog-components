      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return resourceData.store.query(resourceData.filters, null, null, resourceData.pageSize, resourceData.currentPage, resourceData.sort, includeCount).then(function (data) {
              return data;
            });
...
function _getDKANDatastore() {
  ...
  _regenerator["default"].mark(function _callee4(rootURL, resource) {
    var identifier, checkForDatastore, store;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            _context4.next = 7;
            return new _datastore["default"]['dkan'](identifier, checkForDatastore.columns, rootURL);
