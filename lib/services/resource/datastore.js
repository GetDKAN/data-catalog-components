          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 13:
                ...
                return _context6.abrupt("return", this._fetch(range, page * range, new_q, sort_object, count, showDBColumnNames));
            ...
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                return _context9.abrupt("return", new Promise(function (resolve, reject) {
                  _axios["default"].get(_this5.rootUrl + query).then(function (response) {
