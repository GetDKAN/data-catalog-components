...
const DataTablePageResults = ({ total, pageSize, currentPage, className }) => {
  ...
  return (
    <div className={className}>
      <p>
        ...
        <span className="high-result">{currentHighestResult}</span> of{" "}
        <span className="total">{displayTotal}</span> rows
      </p>
    </div>
  );
};
