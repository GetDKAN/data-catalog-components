...
const Resource = ({
  ...
  const statistics =
    "datastore_statistics" in dataInfo
      ? dataInfo.datastore_statistics
      : { rows: parseInt(dataPreview.rowsTotal, 10), columns: columns.length };

  const type =
    data.data && data.data.mediaType ? data.data.mediaType.split("/") : "";
