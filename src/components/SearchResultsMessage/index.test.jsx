...
describe("<SearchResultMessage />", () => {
  ...
  const completeMessage =
    '10 datasets found for "foobar" in Themes: Foo | Keywords: Bar or Run';
  const customDelimiterMessage =
    '10 datasets found for "foobar" in Themes: Foo & Keywords: Bar, Run';
  const condensedMessage =
    '10 datasets found for "foobar" in Themes: Foo | Keywords: 3 selected Keywords';
