...
class Footer extends React.Component {
  render() {
    const menu1 = this.props.links ? (
      <Menu items={this.props.links.footer1} />
    ) : null;
    const menu2 = this.props.links ? (
      <Menu items={this.props.links.footer2} />
    ) : null;
        ...
        <div className="page-footer">
          <Branding>
            ...
            <p>
              ...
              used for its collection, publishing and analysis are also open and
              transparent.
            </p>
            <p>
