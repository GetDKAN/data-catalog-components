...
export { default as MetadataWrapper } from './templates/MetadataWrapper';
export { default as DatastoreWrapper } from './templates/DatastoreWrapper';
export { default as SearchAPIWrapper } from './templates/SearchAPIWrapper';

export { default as MetadataContext } from './templates/MetadataWrapper/MetadataContext';
export { default as DatastoreContext } from './templates/DatastoreWrapper/DatastoreContext';
export { default as SearchAPIContext } from './templates/SearchAPIWrapper/SearchAPIContext';
