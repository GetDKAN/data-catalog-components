...
describe("datatablePageResults", () => {
  test("return 0", () => {
    const results = datatablePageResults(0, 0, 0, false);
  ...
  test("limit higher than total rows", () => {
    const results = datatablePageResults(5, 20, 0, false);
  ...
  test("last page", () => {
    const results = datatablePageResults(205, 20, 200, false);
  ...
  test("page 1", () => {
    const results = datatablePageResults(205, 20, 0, false);
    expect(results.startTotal).toEqual(1);
  ...
  test("random page", () => {
    const results = datatablePageResults(205, 20, 40, false);
  ...
  test("returns with comma", () => {
    const results = datatablePageResults(2000, 20, 1000, true);
